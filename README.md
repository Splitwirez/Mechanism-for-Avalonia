...
##### Main library
- `ToolBarTray` and `ToolBar` (needs work to comply with MVVM)<br/>![ToolBar and ToolBarTray in action](/ReadmeImages/ToolBar-ToolBarTray.gif)
...
- `ToolStrip` (functional but lacks visual polish, needs work to comply with MVVM)<br/>![ToolStrip](/ReadmeImages/ToolStrip.gif)
##### Extras
- `BlenderBar` (needs work to comply with MVVM)<br/>![BlenderBar](/ReadmeImages/BlenderBar.gif)
- `ExpandToFillView` (feature-complete, in need of testing)<br/>![ExpandToFillView](/ReadmeImages/ExpandToFillView.gif)
...
Suggestions closed until further notice
